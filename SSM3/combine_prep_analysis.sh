...
cp totalVCFnoGerm/SA*vcf germremoved_SA_SigProfileranalysis
...
bcftools view -i 'FORMAT/DP>20 & FORMAT/AF<0.7 & FORMAT/AF>0.25' AFgermremovedSSM3.vcf > germremoved_SA_SigProfileranalysis/SSM3_clonal.vcf
bcftools view -i 'FORMAT/DP>20 & FORMAT/AF<=0.25' AFgermremovedSSM3.vcf > germremoved_SA_SigProfileranalysis/SSM3_subclonal.vcf
...
for i in `ls totalVCFnoGerm/SA*vcf`
do
