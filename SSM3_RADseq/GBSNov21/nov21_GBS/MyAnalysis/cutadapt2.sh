...
cutadapt --no-indels -e 0 -g file:bc.fasta -o "cutadapt2/lane1/{name}.fastq.gz" Illumina/SQ1724_HKMH2DRXY_s_1.fastq
cutadapt --no-indels -e 0 -g file:bc.fasta -o "cutadapt2/lane2/{name}.fastq.gz" Illumina/SQ1724_HKMH2DRXY_s_2.fastq
