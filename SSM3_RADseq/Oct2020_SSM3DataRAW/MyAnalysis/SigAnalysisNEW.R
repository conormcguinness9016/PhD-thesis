...
dir.create("Rplots")
dir.create("Rplots/allvars")
png("Rplots/allvars/96profilebysample.png",width = 1000, height = 1000)
#plot_96_profile(SSM3_mm)
plotMutationSpectrum(SSM3_motifs, "sampleNames")
dev.off()
png("Rplots/allvars/cos_heatmap_all.png", width = 1000, height = 1000)
...
png("Rplots/hetvars/96profilebysamplehetsA3Aonly.png", width = 1000, height = 1000)
...
dir.create("Rplots/hetvarsunique")
png("Rplots/hetvarsunique/96profilebysamplehetsunique.png", width = 1000, height = 1000)
...
# plot_96_profile(SSM3hetsunique_mm)
# dev.off()
png("Rplots/hetvarsunique/cos_heatmap_hetsunique.png", width = 1500, height = 1000)
...
png("Rplots/hetvarsunique/96profilebygrouphetsunique.png", width = 1500, height = 1000)
...
png("Rplots/hetvars/96profilebygrouphets.png", width = 1500, height = 1000)
plot_96_profile(SSM3_mm_group)
dev.off()
dd<-subset(SSM3genomhetsunique.gr, group == "NT")

png("Rplots/hetvarsunique/VAFbysamplehetsunique.png")
ggplot(data.frame(dd), aes(clone, VAF)) +
geom_jitter()+geom_violin(alpha =0.5) +theme_classic()
dev.off()
...
dir.create("Rplots/subclonal")
png("Rplots/subclonal/96profilebysamplesc.png", width = 1500, height = 1000)
...
SSM3sc_motifs<-mutationContext(SSM3sc_vr, mygenome)
SSM3sc_mm = motifMatrix(SSM3sc_motifs, group = "sampleNames", normalize = TRUE)
png("Rplots/subclonal/96profilebysampleunique_sc.png", width = 1500, height = 1000)
plotMutationSpectrum(SSM3sc_motifs, group = "sampleNames")
dev.off()
library(reticulate)
py_config("/usr/bin/python3.6")
...
sigprofilerextractor("vcf",
  "sigprofiler",
  "/Volumes/archive/cancergeneticslab/ConorM/Oct2020_SSM3DataRAW/MyAnalysis/totalVCFhets/",
  "mm10")
